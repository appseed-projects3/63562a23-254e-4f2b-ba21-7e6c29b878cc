...
- Timestamp: `2022-07-12 08:59`
- Build ID: `63562a23-254e-4f2b-ba21-7e6c29b878cc`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/63562a23-254e-4f2b-ba21-7e6c29b878cc.git
$ cd 63562a23-254e-4f2b-ba21-7e6c29b878cc
```
